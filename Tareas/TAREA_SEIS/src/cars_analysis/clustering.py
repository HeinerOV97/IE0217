...
def kOptimosAnnosKilometraje(data):
    """
    Funcion que calculara la el numero optimo de clusters
    para realizar los agrupamientos de los datos utilizando
    el kilometraje y anno de fabricacion de los autos como
    caracteristicas
    """
    ...
    plt.title('Metodo del codo kilometraje y anno de fabricacion')
...
def agrupamientoDeDatosAnnosKilometraje(data):
    """
    Con este funcion se agrupan datos
    utilizando el metodo Kmeans, utilizando como
    caracteristicas el kilometraje y el anno de
    fabricacion de los autos
    """
    ...
    plt.xlabel('Anno de fabricacion')
    plt.ylabel('Kilometraje')
    plt.show()


def kOptimosAnnosPrecio(data):
    """
    Funcion que calculara la el numero optimo de clusters
    para realizar los agrupamientos de los datos utilizando
    el precio y anno de fabricacion de los autos como
    caracteristicas
    """

    # Caracteristicas a partir de las cuales se realizaran
    # los agrupamientos en K-Means
    X_cluster = data[['year', 'selling_price']]
    ...
    # Se define una grafico de tipo lineal
    plt.plot(range(1, 21), inertias, marker='o', color='red')
    plt.title('Metodo del codo precio y anno de fabricacion')
    plt.xlabel('Numero de Clusters (k)')
    plt.ylabel('Inercia')
...
def agrupamientoDeDatosAnnosPrecio(data):
    """
    Con este funcion se agrupan datos
    utilizando el metodo Kmeans, utilizando como
    caracteristicas el precio y el anno de
    fabricacion de los autos
    """
    ...
    # grafico de dispersion, el argumento c define
    # que colores se utilizaran para el grafico
    plt.scatter(data['year'], data['selling_price'], c=data['cluster_kmeans'],
                cmap='viridis', marker='.')
    plt.title('Agrupamiento de los vehiculos segun sus caracteristicas')
    plt.xlabel('Anno de fabricacion')
    plt.ylabel('Precio')
